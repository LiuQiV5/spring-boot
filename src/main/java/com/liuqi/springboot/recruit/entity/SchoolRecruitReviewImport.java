...
@Entity
@Table(name = "school_recruit_review_import", schema = "oaapp", catalog = "")
public class SchoolRecruitReviewImport {
    private long id;
    private long fielid;
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        SchoolRecruitReviewImport that = (SchoolRecruitReviewImport) o;
        return id == that.id &&
                fielid == that.fielid &&
