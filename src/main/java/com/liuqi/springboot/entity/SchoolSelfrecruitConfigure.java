...
@Entity
@Table(name = "school_selfrecruit_configure", schema = "oaapp", catalog = "")
public class SchoolSelfrecruitConfigure {
    private long id;
    ...
    public boolean equals(Object o) {
        ...
        SchoolSelfrecruitConfigure that = (SchoolSelfrecruitConfigure) o;
        return id == that.id &&
